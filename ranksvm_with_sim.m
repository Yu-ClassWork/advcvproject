...
%
% opt (as described by Olivier Chappelle below) is a structure containing the
...
n0 = size(A, 1); % size of relative matrix
...
d = size(X,2); % size of feature vector
n = size(A,1); % size of relative matrix
